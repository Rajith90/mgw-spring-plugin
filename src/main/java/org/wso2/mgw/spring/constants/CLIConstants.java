...
public class CLIConstants {
    ...
    public static final String GW_DIST_POLICIES_FILE = "policies.yaml";
    ...
    public static final List<String> ACCESS_CONTROL_ALLOW_METHODS = Collections.unmodifiableList(
            Arrays.asList("GET", "PUT", "POST", "DELETE", "PATCH", "OPTIONS"));
    public static final List<String> ACCESS_CONTROL_ALLOW_HEADERS = Collections.unmodifiableList(Arrays.asList("authorization", "Access-Control-Allow-Origin", "Content-Type", "SOAPAction"));
